...
function renderCalendar(){
  ...
  for(let i=0;i<cellCount;i++){
    ...
    const itemLimit=calendarMode==='week'?8:(window.matchMedia('(max-width:760px)').matches?4:3);
